...
I build out the data models that powered the API endpoints for the Fyyur site by connecting to a PostgreSQL database for storing, querying, and creating information about artists and venues on Fyyur.

## Overview

By the end of this project, you should i had a fully functioning site that is capable of doing the following and  more, using a PostgreSQL database:
